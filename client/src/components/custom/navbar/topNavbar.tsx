    ...
    return (
        <div className="h-full w-full grid grid-cols-[50px_auto_50px] items-center bg-black border-b border-white/20">
            ...
            <div className="flex items-center space-x-2 justify-end">
                <Link to={'/inbox'}>
                    <Button variant={'ghost'} className="bg-transparent border-0 drop-shadow-none text-foreground hover:bg-transparent flex items-center justify-center">
                        <NotificationIcon />
                    </Button>
                </Link>
                <Button variant={'ghost'} className="w-[50px] h-[50px] bg-transparent text-transparent hover:bg-transparent">
                    <Avatar>
